...
st.image('logo_ensae.jpg', caption='Ecole nationale de la Statistique et de l\'Analyse économique', width=None, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
st.snow()
